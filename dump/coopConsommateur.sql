...
(13, 'fueze tea', '0771201703', 'fuzetea@gmail.com', 41110, '12348709787456', '2023-11-10', NULL, 0.000, 0);
...
(2, '$argon2id$v=19$m=65536,t=4,p=1$SDdQTW1TQkhTMzMvdkZwLg$msMlqSNpPTNOGkPZ6FZU5mgkg+BEYqkjZdAZ2vYc0H8', 'MICKAEL ENFREIN', '11-23', '$argon2id$v=19$m=65536,t=4,p=1$SUVXOFdyQnppWTRTREVhOQ$4u+/ZjYnoOZmxMFpMh499/vA/ohuMIchTTGXCF7wB3w', 13);
...
--
ALTER TABLE `Panier`
  MODIFY `IdPanier` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
