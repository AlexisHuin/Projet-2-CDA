<div class="product">
    ...
    <div class="product-description">
        ...
        {if isset($product['PrixProduitProducteur']) && isset($product['DetailsProduitProducteur']) && isset($product['QuantiteProduitProducteur']) && isset($product['ImageProduitProducteur'])}
            <input type="text" name="produit[{$product['IdProduitProducteur']}][DesignationProduitProducteur]" value="{$product['DesignationProduitProducteur']}"/>
            <p>Prix : <input type="text" name="produit[{$product['IdProduitProducteur']}][PrixProduitProducteur]" value="{$product['PrixProduitProducteur']}"/></p>
            <p>Description :<input type="text" name="produit[{$product['IdProduitProducteur']}][DetailsProduitProducteur]" value="{$product['DetailsProduitProducteur']}"/></p>
            <p>Quantité : <input type="number" name="produit[{$product['IdProduitProducteur']}][QuantiteProduitProducteur]" value="{$product['QuantiteProduitProducteur']}"/></p>
